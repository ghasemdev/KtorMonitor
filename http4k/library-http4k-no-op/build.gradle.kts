...
mavenPublishing {
    ...
    val artifact = "ktor-monitor-http4k-filter-no-op"
    coordinates(group.toString(), artifact, version.toString())

    pom {
        name.set("Ktor Monitor - http4k Filter (No-Op)")
        description.set("""No-op implementation of the http4k Filter for Ktor Monitor.""".trimMargin())
...
android {
    namespace = "ro.cosminmihu.ktor.monitor.http4k.noop"
